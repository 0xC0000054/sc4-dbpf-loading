...
class cISC4App : public cIGZUnknown
{
	public:
		...
		virtual intptr_t GetExeceptionReportsDirectory() const = 0; // Returns a cRZString
		...
		virtual bool GetDataDirectory(cIGZString& szPathOutt, int32_t index) = 0;
		virtual bool GetCDDataDirectory(cIGZString& szPathOut, int32_t index) = 0;
		virtual bool GetPluginDirectory(cIGZString& szPathOu) = 0;
